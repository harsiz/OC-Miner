...
- **`oc-miner-cpu`** — command-line, multi-core CPU mining, for machines without a usable GPU/OpenCL driver.
...
cmd/oc-miner-cpu/    CLI miner, multi-core CPU mining
